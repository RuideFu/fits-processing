...
# the output is designed to be used in


def columnLocator(linearPixelFlaggedImage):
    # calculate column indexes
    columnIndexes, mu, sigma, columnVals = columnFlagger(linearPixelFlaggedImage)
    # Define flagged image date
    data = linearPixelFlaggedImage[0].data
    dataTemp = linearPixelFlaggedImage[0].data * 0
    ...
    linearPixelFlaggedImage[0].data = dataTemp

    return linearPixelFlaggedImage, columnIndexes
