...
# [output3] = pixel_eradicator(10, image, image2)
# [output4] = pixel_eradicator(4, image)
[output5] = pixel_eradicator(5, image, image2)
# overwrite the image
# output1.writeto("M1tosend.fits", overwrite=True)
# output2.writeto("M2tosend.fits", overwrite=True)
# output3.writeto("M10tosend.fits", overwrite=True)
# output4.writeto("M4Single3b.fits", overwrite=True)
output5.writeto("M5tosend.fits", overwrite=True)
# close the image
image.close()
